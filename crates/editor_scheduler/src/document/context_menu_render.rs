...
impl Editor {
    ...
    pub fn render_footnote_tooltip(
        &self,
        theme: &Theme,
        window: &Window,
        _cx: &App,
    ...
    pub fn render_menu_separator(theme: &Theme) -> AnyElement {
        let c = &theme.colors;
        let d = &theme.dimensions;
        div()
    ...
    pub fn render_submenu_trigger(
        theme: &Theme,
        id: &'static str,
        label: String,
        is_active: bool,
        submenu_kind: crate::document::context_menu::ContextSubmenu,
        cx: &mut Context<Self>,
    ) -> AnyElement {
        let c = &theme.colors;
        let d = &theme.dimensions;
        ...
        match menu {
            ContextMenuState::Edit {
                ...
                let submenu = active_submenu.map(|sub| {
                    use crate::document::context_menu::ContextSubmenu;
                    ...
                    .child(
                        menu_panel(c, d)
                            ...
                            .child(Self::render_submenu_trigger(
                                ...
                                *active_submenu == Some(crate::document::context_menu::ContextSubmenu::TextFormat),
                                crate::document::context_menu::ContextSubmenu::TextFormat,
                                cx,
                            ))
                            .child(Self::render_submenu_trigger(
                                theme,
                                ...
                                *active_submenu == Some(crate::document::context_menu::ContextSubmenu::ParagraphSettings),
                                crate::document::context_menu::ContextSubmenu::ParagraphSettings,
                                cx,
                            ))
                            .child(Self::render_submenu_trigger(
                                theme,
                                ...
                                *active_submenu == Some(crate::document::context_menu::ContextSubmenu::Insert),
                                crate::document::context_menu::ContextSubmenu::Insert,
                                cx,
                            )),
                    );
    ...
    pub fn render_table_size_picker_overlay(
        &self,
        theme: &Theme,
        window: &Window,
        cx: &mut Context<Self>,
