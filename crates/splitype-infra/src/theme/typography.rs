...
pub struct TypographyStore {
    settings: crate::config::settings::TypographySettings,
...
impl TypographyStore {
    pub fn init(cx: &mut gpui::App, settings: crate::config::settings::TypographySettings) {
    ...
    pub fn update(cx: &mut gpui::App, settings: crate::config::settings::TypographySettings) {
        let (ui, prose, code) = Self::resolve_fonts(&settings);
        cx.set_global(Self {
            settings,
            cached_ui_font: ui,
    ...
    pub fn settings(cx: &gpui::App) -> crate::config::settings::TypographySettings {
        cx.try_global::<Self>()
    ...
    pub fn default_font(scope: TypographyScope) -> gpui::Font {
        let (ui, prose, code) = Self::resolve_fonts(&crate::config::settings::TypographySettings::default());
        match scope {
