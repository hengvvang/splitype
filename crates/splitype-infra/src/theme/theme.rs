...
impl Theme {
    ...
    pub fn callout_style(&self, variant: splitype_model::block::CalloutKind) -> CalloutStyle {
        let c = &self.colors;
        match variant {
            splitype_model::block::CalloutKind::Note => CalloutStyle {
                border_color: c.callout_note_border,
                background_color: c.callout_note_bg,
            },
            splitype_model::block::CalloutKind::Tip => CalloutStyle {
                border_color: c.callout_tip_border,
                background_color: c.callout_tip_bg,
            },
            splitype_model::block::CalloutKind::Important => CalloutStyle {
                border_color: c.callout_important_border,
                background_color: c.callout_important_bg,
            },
            splitype_model::block::CalloutKind::Warning => CalloutStyle {
                border_color: c.callout_warning_border,
                background_color: c.callout_warning_bg,
            },
            splitype_model::block::CalloutKind::Caution => CalloutStyle {
