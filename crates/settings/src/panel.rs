...
use ui::tab::nav_tab;
    ...
    pub fn render_settings_body(
        ...
        let active_tab = SettingsUiState::global(cx).tab;
        ...
        for (tab_idx, tab) in SettingsTab::all().iter().enumerate() {
            ...
            left_nav_items.push(
                ...
                .on_click(move |_event, _window, cx| {
                    SettingsUiState::update(cx, |s, _cx| {
                        s.tab = tab_item;
        ...
        let sections = match active_tab {
            SettingsTab::Interface => render_panel_interface_tab(panel_id, theme, cx),
            SettingsTab::Editor => render_panel_editor_tab(panel_id, theme, cx),
            SettingsTab::Markdown => render_panel_markdown_tab(panel_id, theme, cx),
            SettingsTab::Explorer => render_panel_explorer_tab(panel_id, theme, cx),
            SettingsTab::Startup => render_panel_startup_tab(panel_id, theme, cx),
            SettingsTab::Keymap => render_panel_keymap_tab(panel_id, theme, cx),
        };
    ...
    fn render_panel_interface_tab(
        ...
        let sec1_key = "theme";
        let is_sec1_expanded = SettingsUiState::global(cx).expanded_sections.contains(sec1_key);
        ...
        let theme_lang_props = ThemeLangProps {
            ...
            is_theme_dropdown_open: SettingsUiState::global(cx).open_dropdown.as_deref() == Some("theme"),
            ...
            current_lang_name,
            is_lang_dropdown_open: SettingsUiState::global(cx).open_dropdown.as_deref() == Some("lang"),
        ...
        sections.push(render_theme_and_language_section(
            ...
            is_sec1_expanded,
            toggle_settings_section_handler(cx, sec1_key),
            theme_lang_props,
        ));

        // 2. Status Bar Section
        let sec2_key = "status_bar";
        let is_sec2_expanded = SettingsUiState::global(cx).expanded_sections.contains(sec2_key);
        ...
        sections.push(render_status_bar_section(
            ...
            is_sec2_expanded,
            toggle_settings_section_handler(cx, sec2_key),
            status_bar_props,
        ));
    ...
    fn render_panel_editor_tab(
        ...
        let is_ui_font_open = SettingsUiState::global(cx).open_dropdown.as_deref() == Some("ui_font");
        let is_prose_font_open = SettingsUiState::global(cx).open_dropdown.as_deref() == Some("prose_font");
        let is_code_font_open = SettingsUiState::global(cx).open_dropdown.as_deref() == Some("code_font");
        ...
        let fs_focus = SettingsUiState::cached_focus_handle(cx, |s| &mut s.font_size_focus_handle);
        let lh_focus =
            SettingsUiState::cached_focus_handle(cx, |s| &mut s.line_height_focus_handle);
        ...
        let typography_props = TypographyProps {
            ui_font_name,
            is_ui_font_open,
            search_query_ui_font: SettingsUiState::global(cx).search_query_ui_font.clone(),
            ...
            prose_font_name,
            is_prose_font_open,
            search_query_prose_font: SettingsUiState::global(cx).search_query_prose_font.clone(),
            ...
            code_font_name,
            is_code_font_open,
            search_query_code_font: SettingsUiState::global(cx).search_query_code_font.clone(),
            ...
            is_editing_font_size: SettingsUiState::global(cx).editing_font_size.is_some(),
            edit_buffer_font_size: SettingsUiState::global(cx).editing_font_size.clone(),
            ...
            on_key_down_font_size: Box::new(move |event, _window, cx| {
                ...
                SettingsUiState::update(cx, |s, cx| {
            ...
            is_editing_line_height: SettingsUiState::global(cx).editing_line_height.is_some(),
            edit_buffer_line_height: SettingsUiState::global(cx).editing_line_height.clone(),
        ...
        let tab_size_focus = SettingsUiState::cached_focus_handle(cx, |s| &mut s.tab_size_focus_handle);
        ...
        let editor_behavior_props = EditorBehaviorProps {
            ...
            is_editing_tab_size: SettingsUiState::global(cx).editing_tab_size.is_some(),
            edit_buffer_tab_size: SettingsUiState::global(cx).editing_tab_size.clone(),
    ...
    fn render_panel_markdown_tab(
        ...
        let is_sec_expanded = SettingsUiState::global(cx).expanded_sections.contains(sec_key);
        ...
        let markdown_props = MarkdownProps {
            ...
            is_image_paste_open: SettingsUiState::global(cx).open_dropdown.as_deref() == Some("image_paste"),
        ...
        sections.push(render_markdown_section(
            ...
            is_sec_expanded,
            toggle_settings_section_handler(cx, sec_key),
            markdown_props,
        ));
    ...
    fn render_panel_explorer_tab(
        ...
        let explorer_props = ExplorerProps {
            ...
            is_sort_mode_open: SettingsUiState::global(cx).open_dropdown.as_deref() == Some("exp_sort_mode"),
            ...
            is_sort_order_open: SettingsUiState::global(cx).open_dropdown.as_deref() == Some("exp_sort_order"),
    ...
    fn render_panel_startup_tab(
        ...
        let startup_props = StartupProps {
            ...
            is_startup_open: SettingsUiState::global(cx).open_dropdown.as_deref() == Some("startup"),
    ...
    fn render_panel_keymap_tab(
        ...
        let is_sec3_expanded = SettingsUiState::global(cx).expanded_sections.contains(sec3_key);
        sections.push(render_shortcuts_section(
            c,
            d,
            ...
            is_sec3_expanded,
            toggle_settings_section_handler(cx, sec3_key),
