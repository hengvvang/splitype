...
//! commands live in `crate::editor_model::commands::actions`; the keybinding
//! configuration table lives in `crate::editor_model::commands::keybindings`.
//! Handlers for these actions live in `crate::editor_model::input::block_events`.
