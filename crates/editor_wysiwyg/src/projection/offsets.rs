...
impl Block {
    ...
    pub fn plain_to_display_cursor_offset_with_affinity(
        &self,
        plain: usize,
    ...
    pub fn plain_to_display_range_start(&self, plain: usize) -> usize {
        self.plain_to_display_cursor_offset(plain)
    }

    pub fn plain_to_display_range_end(&self, plain: usize) -> usize {
        self.plain_to_display_cursor_offset(plain)
    }

    pub fn plain_to_display_range(&self, range: Range<usize>) -> Range<usize> {
        if range.is_empty() {
    ...
    pub fn display_to_plain_range(&self, range: Range<usize>) -> Range<usize> {
        self.display_to_plain_offset(range.start)..self.display_to_plain_offset(range.end)
    }

    pub fn display_to_plain_offset(&self, offset: usize) -> usize {
        self.unexpand_offset(offset)
    }

    pub fn projected_move_left_target(
        &self,
        offset: usize,
    ...
    pub fn projected_move_right_target(
        &self,
        offset: usize,
    ) -> Option<(usize, CollapsedCaretAffinity)> {
        self.projection
    ...
    pub fn selection_plain_range(&self) -> Range<usize> {
        self.display_to_plain_range(self.selected_range.clone())
    }

    pub fn display_offset_to_source_offset(&self, display_offset: usize) -> usize {
    ...
    pub fn display_range_to_source_range(&self, range: Range<usize>) -> Range<usize> {
        let start = self.display_offset_to_source_offset(range.start);
        let end = self.display_offset_to_source_offset(range.end);
        start.min(end)..start.max(end)
    }

    pub fn source_offset_to_display_offset(&self, source_offset: usize) -> usize {
        if self.edits_verbatim_text() || self.kind().is_code_block() {
    ...
    pub fn source_range_to_display_range(&self, range: Range<usize>) -> Range<usize> {
