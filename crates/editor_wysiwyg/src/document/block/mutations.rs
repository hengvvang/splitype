...
impl Block {
    ...
    pub fn mark_changed(&mut self, cx: &mut Context<Self>) {
    ...
    pub fn make_separator(&mut self) {
    ...
    pub fn toggle_inline_format(&mut self, format: InlineFormat, cx: &mut Context<Self>) {
