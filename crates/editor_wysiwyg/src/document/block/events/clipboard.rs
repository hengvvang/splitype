...
mod tests {
    ...
    pub fn temp_image_path(name: &str) -> std::path::PathBuf {
    ...
    pub fn remove_temp_image(path: &std::path::Path) {
        let _ = path.parent().map(fs::remove_dir_all);
    }

    #[test]
    pub fn paste_image_text_accepts_plain_local_image_path() {
    ...
    #[test]
    pub fn paste_image_text_accepts_quoted_local_image_path() {
    ...
    #[test]
    pub fn paste_image_text_accepts_file_url() {
    ...
    #[test]
    pub fn paste_image_text_rejects_non_image_path() {
