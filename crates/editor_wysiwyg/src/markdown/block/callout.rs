...
//! The kind lives in `primitives` because it is shared vocabulary between
//! the Markdown domain (`markdown`), the visual theme (`theme`), and the
//! editor renderers — none of which may depend on each other.
