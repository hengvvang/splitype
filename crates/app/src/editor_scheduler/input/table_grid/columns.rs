...
use crate::editor_scheduler::engine::controller::{Editor, TableAxisSelection};
use editor_wysiwyg::document::block::Block;
use editor_wysiwyg::markdown::block::table::{TableAxis, TableCellPosition, TableColumnAlignment};
...
impl Editor {
    pub(crate) fn append_table_column(
        ...
        self.request_autoscroll_active_pane(
            crate::editor_scheduler::engine::controller::AutoscrollStrategy::Fit { margin: px(20.0) },
            cx,
        );
    }
