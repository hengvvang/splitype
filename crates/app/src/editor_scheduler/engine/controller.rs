...
pub(crate) use editor_model::EditorHost;
pub(crate) use editor_wysiwyg::editor_view::EditorView;
pub(crate) use editor_model::AutoscrollStrategy;
...
pub use crate::editor_scheduler::engine::session::{
...
pub(crate) use crate::editor_scheduler::document::context_menu::{ContextMenuState, FootnoteTooltipState};
pub(crate) use crate::editor_scheduler::document::dialogs::TableInsertDialogState;
...
pub(crate) struct PaneState {
    ...
    pub(crate) pane: Box<dyn editor_model::Pane>,
}
...
impl PaneState {
    ...
    #[inline]
    pub(crate) fn as_preview(&self) -> Option<&crate::editor_scheduler::panes::preview::PreviewState> {
        self.pane.as_any().downcast_ref()
    }
    ...
    pub(crate) fn as_preview_mut(
        &mut self,
    ) -> Option<&mut crate::editor_scheduler::panes::preview::PreviewState> {
        self.pane.as_any_mut().downcast_mut()
    }
...
pub(crate) fn new_pane_for_kind(kind: EditorPaneKind) -> Box<dyn editor_model::Pane> {
...
pub struct Editor {
    ...
    pub(crate) pane_host: Arc<dyn editor_model::PaneHost>,
    ...
    pub(crate) search: crate::editor_scheduler::search::SearchPanelState,
...
impl Editor {
    ...
    pub(crate) fn with_session(
        ...
        Self {
            ...
            host: None,
            pane_host: crate::editor_scheduler::engine::pane_host::EditorPaneHost::new(cx.weak_entity()),
            source_view: crate::editor_scheduler::engine::pane_host::EditorSourceView::new(cx.weak_entity()),
            source_ime: crate::editor_scheduler::engine::pane_host::EditorSourceIme::new(cx.weak_entity()),
            search_view: crate::editor_scheduler::engine::pane_host::EditorSearchView::new(cx.weak_entity()),
            search_ime: crate::editor_scheduler::engine::pane_host::EditorSearchIme::new(cx.weak_entity()),
            session,
            panel_rect: None,
            ...
            search: crate::editor_scheduler::search::SearchPanelState::new(cx),
