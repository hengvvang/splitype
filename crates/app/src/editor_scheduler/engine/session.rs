...
pub struct EditorSession {
    pub(crate) tab_list: EditorTabList<crate::editor_scheduler::engine::controller::DocumentTab>,
...
impl EditorSession {
    ...
    #[inline]
    pub(crate) fn active_tab(&self) -> Option<&crate::editor_scheduler::engine::controller::DocumentTab> {
        self.tab_list.active_tab()
    }

    #[inline]
    pub(crate) fn active_tab_mut(&mut self) -> Option<&mut crate::editor_scheduler::engine::controller::DocumentTab> {
        self.tab_list.active_tab_mut()
    }

    #[inline]
    pub(crate) fn tab(&self, index: usize) -> Option<&crate::editor_scheduler::engine::controller::DocumentTab> {
        self.tab_list.get(index)
    }

    #[inline]
    pub(crate) fn tab_mut(&mut self, index: usize) -> Option<&mut crate::editor_scheduler::engine::controller::DocumentTab> {
    ...
    #[inline]
    pub(crate) fn close_tab(&mut self, index: usize) -> Option<crate::editor_scheduler::engine::controller::DocumentTab> {
        self.tab_list.close_tab(index)
    }

    #[inline]
    pub(crate) fn tabs(&self) -> impl Iterator<Item = &crate::editor_scheduler::engine::controller::DocumentTab> {
        self.tab_list.iter()
    }

    #[inline]
    pub(crate) fn tabs_mut(&mut self) -> impl Iterator<Item = &mut crate::editor_scheduler::engine::controller::DocumentTab> {
        self.tab_list.iter_mut()
    }

    #[inline]
    pub(crate) fn push_tab(&mut self, tab: crate::editor_scheduler::engine::controller::DocumentTab) -> usize {
