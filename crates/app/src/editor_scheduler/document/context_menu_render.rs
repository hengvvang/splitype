...
use crate::editor_scheduler::document::context_menu::ContextMenuState;
...
impl Editor {
    ...
    pub(crate) fn render_submenu_trigger(
        ...
        label: String,
        is_active: bool,
        submenu_kind: crate::editor_scheduler::document::context_menu::ContextSubmenu,
        cx: &mut Context<Self>,
    ) -> AnyElement {
        let c = &theme.colors;
        let d = &theme.dimensions;
        ...
        match menu {
            ContextMenuState::Edit {
                ...
                let submenu = active_submenu.map(|sub| {
                    use crate::editor_scheduler::document::context_menu::ContextSubmenu;
                    ...
                    .child(
                        menu_panel(c, d)
                            ...
                            .child(Self::render_submenu_trigger(
                                ...
                                *active_submenu == Some(crate::editor_scheduler::document::context_menu::ContextSubmenu::TextFormat),
                                crate::editor_scheduler::document::context_menu::ContextSubmenu::TextFormat,
                                cx,
                            ))
                            .child(Self::render_submenu_trigger(
                                theme,
                                ...
                                *active_submenu == Some(crate::editor_scheduler::document::context_menu::ContextSubmenu::ParagraphSettings),
                                crate::editor_scheduler::document::context_menu::ContextSubmenu::ParagraphSettings,
                                cx,
                            ))
                            .child(Self::render_submenu_trigger(
                                theme,
                                ...
                                *active_submenu == Some(crate::editor_scheduler::document::context_menu::ContextSubmenu::Insert),
                                crate::editor_scheduler::document::context_menu::ContextSubmenu::Insert,
                                cx,
                            )),
                    );
