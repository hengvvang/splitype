...
use markdown_parser::inline::footnote::InlineFootnoteHit;
use markdown_parser::inline::link::InlineLinkHit;
...
pub fn source_line_count(text: &str) -> usize {
    text.split('\n').count().max(1)
}

pub fn source_line_number_gutter_width(line_count: usize, font_size: Pixels) -> Pixels {
...
pub fn source_text_bounds(bounds: Bounds<Pixels>, gutter_width: Pixels) -> Bounds<Pixels> {
...
pub fn source_line_number_tops(lines: &[WrappedLine], line_height: Pixels) -> Vec<Pixels> {
...
pub fn hard_line_ranges(text: &str) -> Vec<Range<usize>> {
...
pub fn line_index_for_offset(ranges: &[Range<usize>], offset: usize) -> (usize, usize) {
    if ranges.is_empty() {
        return (0, 0);
    }
...
pub fn wrapped_line_height(line: &WrappedLine, line_height: Pixels) -> Pixels {
...
pub fn wrap_boundary_offset(line: &WrappedLine, wrap_idx: usize) -> Option<usize> {
...
pub fn wrapped_row_offsets(line: &WrappedLine) -> Vec<usize> {
...
pub fn cursor_bounds_for_offset(
    lines: &[WrappedLine],
    bounds: Bounds<Pixels>,
    line_height: Pixels,
    text: &str,
...
pub fn range_segment_bounds_for_hard_line(
    lines: &[WrappedLine],
    bounds: Bounds<Pixels>,
    line_height: Pixels,
    line_idx: usize,
...
pub fn point_inside_bounds(bounds: Bounds<Pixels>, position: Point<Pixels>) -> bool {
