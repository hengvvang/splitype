...
impl Block {
    ...
    pub fn vertical_anchor_x(&self) -> Pixels {
    ...
    pub fn end_pointer_selection_session(&mut self) -> bool {
    ...
    pub fn selection_anchor_focus(&self) -> (usize, usize) {
        if self.selection_reversed {
    ...
    pub fn plain_selection_anchor_focus(&self) -> (usize, usize) {
    ...
    pub fn set_selection_from_anchor_focus(&mut self, anchor: usize, focus: usize) {
    ...
    pub fn set_selection_from_plain_anchor_focus(
        &mut self,
        anchor: usize,
        focus: usize,
    ...
    pub fn range_to_utf16(&self, range: &Range<usize>) -> Range<usize> {
        markdown_parser::inline::offsets::ImeConverter::utf8_range_to_utf16_in(
            self.display_text(),
            range,
        )
    }
    ...
    pub fn range_from_utf16(&self, range_utf16: &Range<usize>) -> Range<usize> {
        markdown_parser::inline::offsets::ImeConverter::utf16_range_to_utf8_in(
            self.display_text(),
            range_utf16,
        )
    }
    ...
    pub fn unexpand_offset(&self, expanded: usize) -> usize {
...
pub fn normalize_code_language_input(text: &str) -> String {
    text.replace("\r\n", " ")
        .replace(['\r', '\n'], " ")
        .trim()
        .to_string()
