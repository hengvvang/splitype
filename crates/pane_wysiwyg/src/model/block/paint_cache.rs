...
impl Block {
    ...
    pub fn last_paint_at(&self, position: Point<Pixels>) -> Option<&BlockLastPaint> {
        self.last_paints
            .iter()
            .rev()
    ...
    pub fn code_language_paint(&self) -> Option<&CodeLanguageLastPaint> {
        self.code_toolbar.picker.paints.last()
    }

    pub fn active_range_or_cursor_bounds(&self) -> Option<Bounds<Pixels>> {
