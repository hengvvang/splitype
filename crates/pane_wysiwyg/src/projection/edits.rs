...
impl Block {
    ...
    pub fn normalize_after_text_edit(
        &self,
    ...
    pub fn quote_line_starts_block_syntax(line: &str) -> bool {
    ...
    pub fn multiline_quote_edit_requires_reparse(text: &str) -> bool {
        text.split('\n')
            .skip(1)
            .any(Self::quote_line_starts_block_syntax)
    }

    pub fn adjust_range_for_shortcut(
        range: &Range<usize>,
    ...
    pub fn apply_link_projection_edit(
        &mut self,
    ...
    pub fn insertion_attributes_for_display_offset(
        &self,
    ...
    pub fn collapsed_caret_inherits_inline_code_style(&self) -> bool {
    ...
    pub fn heading_projection_prefix_range(&self) -> Option<Range<usize>> {
        self.projection
            .as_ref()
            .and_then(|projection| projection.block_prefix_range.clone())
    }

    pub fn heading_source_offset_for_display_offset(
        &self,
        display_offset: usize,
        prefix_len: usize,
    ) -> usize {
    ...
    pub fn source_range_to_plain_range(
        text: &BlockText,
    ...
    pub fn content_source_offset_to_display_offset(
        &self,
        content_source_start: usize,
        source_offset: usize,
    ) -> usize {
    ...
    pub fn callout_projection_prefix_range(&self) -> Option<Range<usize>> {
    ...
    pub fn apply_callout_prefix_edit(
        &mut self,
        display_range: Range<usize>,
        new_text: &str,
        selected_range_relative: Option<Range<usize>>,
    ...
    pub fn apply_heading_prefix_edit(
        &mut self,
        display_range: Range<usize>,
        new_text: &str,
        selected_range_relative: Option<Range<usize>>,
    ...
    /// tree's offset space.
    pub fn replace_text_in_display_range(
        &mut self,
        display_range: Range<usize>,
        new_text: &str,
        selected_range_relative: Option<Range<usize>>,
