    ...
    pub(crate) fn on_interaction_event(
        ...
        match event {
            BlockEvent::RequestOpenLink {
                ...
                let intent = crate::navigation::NavigationIntent::new(
                    crate::navigation::NavigationTarget::External {
                        raw: prompt_target.clone(),
                        resolved: open_target.clone(),
                    },
                    crate::navigation::NavigationMode::Wysiwyg,
                    modifiers,
                );
            ...
            BlockEvent::RequestJumpToFootnoteDefinition { id, .. } => {
                let intent = crate::navigation::NavigationIntent::new(
                    crate::navigation::NavigationTarget::FootnoteDefinition { id: id.clone() },
                    crate::navigation::NavigationMode::Wysiwyg,
                    Modifiers::default(),
                );
                self.execute_navigation(intent, cx);
            ...
            BlockEvent::RequestJumpToFootnoteBackref { id } => {
                let intent = crate::navigation::NavigationIntent::new(
                    crate::navigation::NavigationTarget::FootnoteReference { id: id.clone() },
                    crate::navigation::NavigationMode::Wysiwyg,
                    Modifiers::default(),
                );
                self.execute_navigation(intent, cx);
