...
impl EditorSession {
    ...
    #[inline]
    pub fn active_tab(&self) -> Option<&crate::engine::controller::DocumentTab> {
        self.tab_list.active_tab()
    }

    #[inline]
    pub fn active_tab_mut(&mut self) -> Option<&mut crate::engine::controller::DocumentTab> {
        self.tab_list.active_tab_mut()
    }

    #[inline]
    pub fn tab(&self, index: usize) -> Option<&crate::engine::controller::DocumentTab> {
        self.tab_list.get(index)
    }

    #[inline]
    pub fn tab_mut(&mut self, index: usize) -> Option<&mut crate::engine::controller::DocumentTab> {
    ...
    #[inline]
    pub fn close_tab(&mut self, index: usize) -> Option<crate::engine::controller::DocumentTab> {
        self.tab_list.close_tab(index)
    }

    #[inline]
    pub fn tabs(&self) -> impl Iterator<Item = &crate::engine::controller::DocumentTab> {
        self.tab_list.iter()
    }

    #[inline]
    pub fn tabs_mut(&mut self) -> impl Iterator<Item = &mut crate::engine::controller::DocumentTab> {
        self.tab_list.iter_mut()
    }

    #[inline]
    pub fn push_tab(&mut self, tab: crate::engine::controller::DocumentTab) -> usize {
