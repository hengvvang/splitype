...
use crate::commands::edit_command::{
...
use crate::document::dialogs::TableInsertDialogState;
...
impl Editor {
    ...
    pub fn open_table_axis_context_menu(
        &mut self,
        position: Point<Pixels>,
        selection: TableAxisSelection,
        cx: &mut Context<Self>,
    ...
    pub fn close_table_insert_dialog(&mut self, cx: &mut Context<Self>) {
    ...
    pub fn dismiss_contextual_overlays(&mut self, cx: &mut App) {
        let had_menu = self.context_menu.take().is_some();
    ...
    pub fn set_context_menu_submenu_hover(
        &mut self,
    ...
    pub fn on_editor_context_menu_mouse_down(
        &mut self,
    ...
    pub fn on_source_context_menu_mouse_down(
        &mut self,
        event: &MouseDownEvent,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub fn on_block_context_menu_mouse_down(
        &mut self,
        entity_id: EntityId,
        event: &MouseDownEvent,
        _window: &mut Window,
    ...
    pub fn on_dismiss_context_menu_overlay(
        &mut self,
    ...
    pub fn on_dismiss_transient_ui(
        &mut self,
    ...
    pub fn on_open_table_insert_dialog(
        &mut self,
        _event: &ClickEvent,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub fn insert_table_from_dialog(
        &mut self,
        rows: usize,
        cols: usize,
        cx: &mut Context<Self>,
    ...
    pub fn handle_table_insert_key_down(
        &mut self,
        event: &KeyDownEvent,
        cx: &mut Context<Self>,
    ) {
    ...
    pub fn confirm_table_insert_action(&mut self, cx: &mut Context<Self>) {
        let Some(dialog) = self.table_insert_dialog.take() else {
            return;
        };
        self.execute_edit_command(
    ...
    pub fn context_menu_has_selection(&self, cx: &App) -> bool {
        let pane_id = self.active_pane_id();
    ...
    pub fn context_menu_target_block(
        &self,
        target_entity: Option<EntityId>,
    ) -> Option<Entity<Block>> {
        let pane_id = self.active_pane_id();
    ...
    pub fn on_context_menu_paste_plain(
        &mut self,
        _event: &ClickEvent,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub fn on_context_menu_select_all(
        &mut self,
        _event: &ClickEvent,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub fn on_format_strikethrough(
        &mut self,
        _event: &ClickEvent,
        _window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub fn on_insert_thematic_break(
        &mut self,
        _event: &ClickEvent,
        _window: &mut Window,
        cx: &mut Context<Self>,
