...
impl<'a> DisplaySnapshot<'a> {
    ...
    pub fn visible_line_count(&self) -> u32 {
        self.fold_map
            .visible_line_count(self.line_map.line_count() as u32)
    }
    ...
    pub fn buffer_point_to_display_point(&self, point: BufferPoint) -> DisplayPoint {
        ...
        let display_col = self
            .tab_map
            .char_column_to_display_column(line_str, point.column);
    ...
    pub fn display_point_to_buffer_point(&self, point: DisplayPoint) -> BufferPoint {
        ...
        let buffer_row = self
            .fold_map
            .visible_row_to_buffer_row(point.row, total_rows);
        ...
        let buffer_col = self
            .tab_map
            .display_column_to_char_column(line_str, point.column);
