    ...
    pub fn default_theme() -> Self {
        Self {
            ...
            colors: ThemeColors {
                ...
                text_default: Hsla::from(rgba(0xf4f4f5ff)),
                text_link: Hsla::from(rgba(0x4f80ffff)),
                markdown_marker: Hsla::from(rgba(0xa855f7ff)),
                text_placeholder: Hsla::from(rgba(0x71717acc)),
                text_h1: Hsla::from(rgba(0xf4f4f5ff)),
                text_h2: Hsla::from(rgba(0xf4f4f5ff)),
                text_h3: Hsla::from(rgba(0xf4f4f5ff)),
                text_h4: Hsla::from(rgba(0xf4f4f5ff)),
                text_h5: Hsla::from(rgba(0xf4f4f5ff)),
                text_h6: Hsla::from(rgba(0xf4f4f5ff)),
                border_h1: Hsla::from(rgba(0x3f3f46ff)),
                border_h2: Hsla::from(rgba(0x3f3f46aa)),
                text_quote: Hsla::from(rgba(0xd4d4d8ff)),
                border_quote: Hsla::from(rgba(0x52525bff)),
                callout_note_bg: Hsla::from(rgba(0x4f80ff14)),
                callout_note_border: Hsla::from(rgba(0x4f80ffff)),
                callout_tip_bg: Hsla::from(rgba(0x10b98114)),
                callout_tip_border: Hsla::from(rgba(0x10b981ff)),
                callout_important_bg: Hsla::from(rgba(0x8b5cf614)),
                callout_important_border: Hsla::from(rgba(0x8b5cf6ff)),
                callout_warning_bg: Hsla::from(rgba(0xf59e0b14)),
                callout_warning_border: Hsla::from(rgba(0xf59e0bff)),
                callout_caution_bg: Hsla::from(rgba(0xef444414)),
                callout_caution_border: Hsla::from(rgba(0xef4444ff)),
                footnote_border: Hsla::from(rgba(0x3f3f4680)),
                footnote_backref: Hsla::from(rgba(0x4f80ffff)),
                task_checkbox_border: Hsla::from(rgba(0x71717aff)),
                task_checkbox_bg: Hsla::from(rgba(0x00000000)),
                task_checkbox_checked_bg: Hsla::from(rgba(0x4f80ffff)),
                task_checkbox_check: Hsla::from(rgba(0xffffffff)),
                separator: Hsla::from(rgba(0x2e2e32ff)),
                code_bg: Hsla::from(rgba(0x202023ff)),
                text_highlight_bg: Hsla::from(rgba(0xffd1664d)),
                code_text: Hsla::from(rgba(0xf4f4f5ff)),
                code_language_input_bg: Hsla::from(rgba(0x27272aff)),
                code_language_input_border: Hsla::from(rgba(0x3f3f46cc)),
                code_language_input_text: Hsla::from(rgba(0xf4f4f5ff)),
                code_language_input_placeholder: Hsla::from(rgba(0x71717acc)),
                ...
                table_border: Hsla::from(rgba(0x2e2e32ff)),
                table_header_bg: Hsla::from(rgba(0x202023ff)),
                table_cell_bg: Hsla::from(rgba(0x18181bff)),
                table_cell_active_outline: Hsla::from(rgba(0x4f80ffff)),
                table_axis_preview_bg: Hsla::from(rgba(0x4f80ff14)),
                table_axis_selected_bg: Hsla::from(rgba(0x4f80ff26)),
                table_append_button_bg: Hsla::from(rgba(0x27272aff)),
                table_append_button_hover: Hsla::from(rgba(0x323236ff)),
                table_append_button_text: Hsla::from(rgba(0xf4f4f5ff)),
                table_handle_bg: Hsla::from(rgba(0x2e2e32ff)),
                table_handle_icon: Hsla::from(rgba(0xa1a1aaff)),
                table_selection_border: Hsla::from(rgba(0x4f80ffff)),
                image_placeholder_bg: Hsla::from(rgba(0x202023ff)),
                image_placeholder_border: Hsla::from(rgba(0x2e2e32ff)),
                image_placeholder_text: Hsla::from(rgba(0xa1a1aaff)),
                image_caption_text: Hsla::from(rgba(0x71717aff)),
                scrollbar_thumb: Hsla::from(rgba(0xa1a1aa4d)),
                cursor: Hsla::from(rgba(0x4f80ffff)),
                selection: Hsla::from(rgba(0x4f80ff40)),
                focus_accent: Hsla::from(rgba(0x4f80ffff)),
                split_indicator: Hsla::from(rgba(0x4f80ffff)),
                dialog_backdrop: Hsla::from(rgba(0x00000080)),
                dialog_surface: Hsla::from(rgba(0x202023ff)),
                dialog_border: Hsla::from(rgba(0x2e2e32ff)),
                dialog_title: Hsla::from(rgba(0xf4f4f5ff)),
                dialog_body: Hsla::from(rgba(0xd4d4d8ff)),
                dialog_muted: Hsla::from(rgba(0x71717aff)),
                dialog_primary_button_bg: Hsla::from(rgba(0x4f80ffff)),
            ...
            dimensions: ThemeDimensions {
                ...
                code_language_input_radius: 4.0,
                ...
                button_radius: 4.0,
                icon_button_radius: 4.0,
                tab_radius: 4.0,
                tab_close_button_radius: 2.0,
                ...
                select_trigger_radius: 4.0,
                select_panel_radius: 8.0,
                select_option_radius: 4.0,
                stepper_radius: 4.0,
                ...
                badge_radius: 4.0,
                section_card_radius: 8.0,
                settings_row_radius: 4.0,
                topbar_height: 28.0,
    ...
    pub fn light_theme() -> Self {
        ...
        Self {
            ...
            colors: ThemeColors {
                ...
                text_default: Hsla::from(rgba(0x18181bff)),
                text_link: Hsla::from(rgba(0x2563ebff)),
                markdown_marker: Hsla::from(rgba(0x9333eaff)),
                text_placeholder: Hsla::from(rgba(0xa1a1aacc)),
                text_h1: Hsla::from(rgba(0x18181bff)),
                text_h2: Hsla::from(rgba(0x18181bff)),
                text_h3: Hsla::from(rgba(0x18181bff)),
                text_h4: Hsla::from(rgba(0x18181bff)),
                text_h5: Hsla::from(rgba(0x18181bff)),
                text_h6: Hsla::from(rgba(0x18181bff)),
                border_h1: Hsla::from(rgba(0xe4e4e7ff)),
                border_h2: Hsla::from(rgba(0xe4e4e7cc)),
                text_quote: Hsla::from(rgba(0x52525bff)),
                border_quote: Hsla::from(rgba(0xd4d4d8ff)),
                callout_note_bg: Hsla::from(rgba(0x2563eb10)),
                callout_note_border: Hsla::from(rgba(0x2563ebff)),
                callout_tip_bg: Hsla::from(rgba(0x16a34a10)),
                callout_tip_border: Hsla::from(rgba(0x16a34aff)),
                callout_important_bg: Hsla::from(rgba(0x7c3aed10)),
                callout_important_border: Hsla::from(rgba(0x7c3aedff)),
                callout_warning_bg: Hsla::from(rgba(0xea580c10)),
                callout_warning_border: Hsla::from(rgba(0xea580cff)),
                callout_caution_bg: Hsla::from(rgba(0xdc262610)),
                callout_caution_border: Hsla::from(rgba(0xdc2626ff)),
                footnote_border: Hsla::from(rgba(0xe4e4e7ff)),
                footnote_backref: Hsla::from(rgba(0x2563ebff)),
                task_checkbox_border: Hsla::from(rgba(0xa1a1aaff)),
                task_checkbox_bg: Hsla::from(rgba(0xffffffff)),
                task_checkbox_checked_bg: Hsla::from(rgba(0x2563ebff)),
                task_checkbox_check: Hsla::from(rgba(0xffffffff)),
                separator: Hsla::from(rgba(0xe4e4e7ff)),
                code_bg: Hsla::from(rgba(0xf4f4f5ff)),
                text_highlight_bg: Hsla::from(rgba(0xffe06680)),
                code_text: Hsla::from(rgba(0x18181bff)),
                code_language_input_bg: Hsla::from(rgba(0xffffffff)),
                code_language_input_border: Hsla::from(rgba(0xe4e4e7ff)),
                code_language_input_text: Hsla::from(rgba(0x18181bff)),
                code_language_input_placeholder: Hsla::from(rgba(0xa1a1aacc)),
                ...
                code_syntax_variable: Hsla::from(rgba(0x18181bff)),
                ...
                table_border: Hsla::from(rgba(0xe4e4e7ff)),
                table_header_bg: Hsla::from(rgba(0xf4f4f5ff)),
                table_cell_bg: Hsla::from(rgba(0xffffffff)),
                table_cell_active_outline: Hsla::from(rgba(0x2563ebff)),
                table_axis_preview_bg: Hsla::from(rgba(0x2563eb10)),
                table_axis_selected_bg: Hsla::from(rgba(0x2563eb20)),
                table_append_button_bg: Hsla::from(rgba(0xf4f4f5ff)),
                table_append_button_hover: Hsla::from(rgba(0xe4e4e7ff)),
                table_append_button_text: Hsla::from(rgba(0x18181bff)),
                table_handle_bg: Hsla::from(rgba(0xe4e4e7ff)),
                table_handle_icon: Hsla::from(rgba(0x71717aff)),
                table_selection_border: Hsla::from(rgba(0x2563ebff)),
                image_placeholder_bg: Hsla::from(rgba(0xfbfbfcff)),
                image_placeholder_border: Hsla::from(rgba(0xe4e4e7ff)),
                image_placeholder_text: Hsla::from(rgba(0x71717aff)),
                image_caption_text: Hsla::from(rgba(0x71717aff)),
                scrollbar_thumb: Hsla::from(rgba(0x71717a4d)),
                cursor: Hsla::from(rgba(0x2563ebff)),
                selection: Hsla::from(rgba(0x2563eb26)),
                focus_accent: Hsla::from(rgba(0x2563ebff)),
                split_indicator: Hsla::from(rgba(0x2563ebff)),
                dialog_backdrop: Hsla::from(rgba(0x00000040)),
                dialog_surface: Hsla::from(rgba(0xffffffff)),
                dialog_border: Hsla::from(rgba(0xe4e4e7ff)),
                dialog_title: Hsla::from(rgba(0x18181bff)),
                dialog_body: Hsla::from(rgba(0x3f3f46ff)),
                dialog_muted: Hsla::from(rgba(0x71717aff)),
