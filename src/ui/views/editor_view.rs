...
use crate::ui::input::shortcuts::{NoRecentFiles, SelectLanguage, SelectTheme};
...
pub fn footnote_row_top_gap(previous: Option<RenderedRowSpacingInfo>, default_gap: f32) -> f32 {
    let Some(previous) = previous else {
        return 0.0;
    };
...
/// A centered muted-text prompt for empty tiled panels (workspace files,
/// outline).
