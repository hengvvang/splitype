//! Standalone helpers for Markdown file drop detection and Editor drop handling.
...
impl Editor {
    pub(crate) fn on_external_paths_drop(
        ...
        let Some(path) = first_dropped_markdown_path(paths.paths()) else {
    ...
    pub(crate) fn replace_document_from_path(
        ...
        crate::app::menu::record_recent_file_from_editor(path, cx);
        Ok(())
    }
