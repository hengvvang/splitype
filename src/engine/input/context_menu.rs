...
use crate::blocks::{DismissTransientUi, TableAxisKind, TableColumnAlignment, TableData};
use crate::engine::editor::{Editor, TableAxisSelection, EditMode};
...
impl Editor {
    ...
    pub(crate) fn on_toggle_table_headers(
        ...
        let next = !crate::workspace::EditorSettings::show_table_headers(cx);
        crate::workspace::EditorSettings::set_show_table_headers(cx, next);
        self.close_context_menu(cx);
            ...
            ContextMenuState::TableAxis {
                ...
                let items = match selection.kind {
                    ...
                    TableAxisKind::Row => {
                        ...
                        if selection.index == 0 {
                            let headers_shown =
                                crate::workspace::EditorSettings::show_table_headers(cx);
                            items.push(
                                div()
