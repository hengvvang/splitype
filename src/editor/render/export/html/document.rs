...
use crate::editor::render::export::html::rewriter::{
...
use crate::editor::render::export::html::styles::{chromium_pdf_theme_css, escape_html, theme_css};
...
pub(crate) fn contains_tibetan_text(text: &str) -> bool {
    text.chars()
