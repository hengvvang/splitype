...
use crate::model::block::image::{ImageReferenceDefinitions, ImageSyntax, resolve_image_source};
...
impl PreviewBlock {
    ...
    pub fn has_footnote_definition_backref(&self) -> bool {
        ...
        let (id, _) = crate::model::block::footnote::split_footnote_definition_text(&plain_text);
    ...
    pub fn is_standalone_image(&self) -> bool {
        ...
        crate::model::block::image::parse_standalone_image(&plain).is_some()
    }
