...
use crate::editor::plugins::latex_render::{inline_math_font_size, render_inline_math_svg};
...
use crate::editor::panes::wysiwyg::render::inline::text_element::BlockTextElement;
        ...
        if let Some(footnote) = span.footnote.clone() {
            ...
            let element = element
                ...
                .on_hover(cx.listener(move |_block, hovered: &bool, window, cx| {
                    ...
                    cx.emit(crate::editor::document::protocol::BlockEvent::RequestFootnoteTooltip {
                ...
                .on_mouse_up(
                    ...
                    cx.listener(move |_block, _event: &MouseUpEvent, _window, cx| {
                        cx.stop_propagation();
                        cx.emit(crate::editor::document::protocol::BlockEvent::RequestJumpToFootnoteDefinition {
