//! Keybinding configuration — user-configurable shortcut table and binding
//! installation.
//!
//! The `ShortcutCommand` registry covers both block-editing and window/menu
//! commands; the action types themselves live in
//! `crate::editor::editing::input::shortcuts` (block editing) and
//! `crate::editor::windows::actions` (window commands).
...
use crate::editor::editing::input::shortcuts::{
    ...
    ItalicSelection, JumpToBottom, JumpToTop, MoveLeft, MoveRight, Newline, OutdentBlock,
    PageDown, PageUp, Paste, Redo, SelectAll, SelectEnd, SelectHome, SelectLeft, SelectRight,
...
use crate::editor::windows::actions::{
    ...
    ToggleViewMode, ToggleWorkspace,
};
