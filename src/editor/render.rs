...
impl Editor {
            ...
            .on_mouse_move(move |event, window, cx| {
                ...
                let _ = root_editor_move.update(cx, |ed, cx| {
                    ...
                    if let Some(drag) = ed.area_layout.active_splitter_drag {
                        ...
                        {
                            let current_pos = match drag.direction {
                                SplitDirection::Horizontal => f32::from(pos.x) - ex,
                                SplitDirection::Vertical => f32::from(pos.y) - ey,
                            };
                            ...
                            let span = ed
                                ...
                                .unwrap_or_else(|| match drag.direction {
                                    SplitDirection::Horizontal => ew,
                                    SplitDirection::Vertical => eh,
                                });
                            if span > 1.0 {
                                let mut session = drag;
                                session.total_span = span;
                ...
                match drag.preview {
                    ...
                    CornerDragPreview::JoinPreview {
                            ...
                            .get_leaf_pixel_rect(container_id, &outer_rects)
                        {
                            ...
                            {
                                let arrow_symbol = match direction {
                                    ScreenDirection::North => "N",
                                    ScreenDirection::South => "S",
                                    ScreenDirection::East => "E",
                                    ScreenDirection::West => "W",
                                };
                                Some(
                                    div()
                                        .absolute()
    ...
    fn render_area_dropdown_menu(
        ...
        let available_types = AreaType::all();
