...
use crate::workspace::{ThemeColors, ThemeManager};
...
mod tests {
    ...
    use crate::blocks::{Block, BlockType, BlockData, RichText, TableCellPosition};
    use gpui::{
    ...
    async fn link_hit_respects_center_alignment(cx: &mut TestAppContext) {
        ...
        let block = cx.new(|cx| {
            ...
            block.set_table_cell_mode(
                ...
                crate::blocks::TableColumnAlignment::Center,
            );
            block
        });
