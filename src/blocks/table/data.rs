...
use crate::blocks::{Block, RichText};
...
impl TableData {
    ...
    pub fn insert_column_at(&mut self, col_idx: usize, alignment: TableColumnAlignment) {
        ...
        self.header
            .insert(idx, RichText::plain(String::new()));
...
fn measurement_runs(cache: &crate::blocks::InlineRenderCache, base_run: &TextRun) -> Vec<TextRun> {
...
pub(crate) fn serialize_table_cell_markdown(tree: &RichText) -> String {
