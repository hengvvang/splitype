...
use crate::blocks::InlineFootnoteReference;
use crate::blocks::inline::text::{
    InlineFragment, InlineLink, InlineRenderCache, InlineScript, InlineStyle, RichText,
    StyleFlag, can_use_markdown_script_delimiters,
};

use crate::blocks::CollapsedCaretAffinity;
...
#[cfg(test)]
pub(crate) fn expanded_display_offset_for_clean(
...
#[cfg(test)]
pub(crate) fn expanded_display_cursor_offset_for_clean(
    fragments: &[InlineFragment],
    clean: usize,
) -> usize {
    let mut display = 0usize;
...
impl ExpandedInlineProjection {
    ...
    pub(crate) fn link_run_fully_covering_range(
        &self,
        range: &Range<usize>,
