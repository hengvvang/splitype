...
use super::CodeHighlightResult;
use super::{
    BlockAction, BlockType, BlockData, CalloutVariant, FootnoteMap, InlineFootnoteHit,
    UndoCaptureKind,
};
use super::{ImageReferenceDefinitions, ImageResolvedSource, LinkReferenceDefinitions};
pub(crate) use crate::blocks::code::language::{
    code_language_display_name, code_language_options_matching,
};
use crate::blocks::inline::projection::{
    ExpandedInlineProjection, ExpandedInlineSegment, ExpandedInlineSegmentKind, ExpandedLinkRun,
    ProjectedLinkSelectionSnapshot,
};
use crate::blocks::inline::text::{
    InlineFragment, InlineInsertionAttributes, InlineLinkHit, InlineRenderCache, InlineSpan,
    InlineStyle, RichText, StyleFlag,
};
use crate::blocks::{
    TableAxisHighlight, TableAxisMarker, TableCellPosition, TableColumnAlignment, TableGrid,
};
...
impl EditMode {
    fn for_kind(kind: &BlockType) -> Self {
...
impl Block {
    ...
    pub(crate) fn inline_html_style_at(
        &self,
        offset: usize,
    ) -> Option<crate::blocks::HtmlInlineStyle> {
    ...
    #[allow(dead_code)]
    pub(crate) fn inline_math_at(&self, offset: usize) -> Option<&crate::blocks::InlineMath> {
