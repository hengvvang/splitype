...
//!
//! - **State & model** live in `crate::editor::panels::explorer` (owned by
...
//! `crate::editor::panels::outline`; the sidebar state and file-tree model
//! live in `crate::editor::panels::explorer`.
