...
| --- | --- | --- |
| `custom-theme.example.jsonc` | Theme | Overriding colors, typography, layout tokens, menus, dialogs, code highlighting |
...
optional, missing values inherit from the built-in base theme (`splitype` or
`splitype-light`) or the English language pack.
